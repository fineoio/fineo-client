...
//import io.fineo.read.io.fineo.client.auth.auth.cognito.AttributeType;
...
public class AuthenticationDetails {
     ...
     * @param validationData    REQUIRED: Validation data parameters for the pre-io.fineo.client.auth.auth lambda.
     */
