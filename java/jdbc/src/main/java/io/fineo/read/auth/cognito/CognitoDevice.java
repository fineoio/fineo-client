...
import io.fineo.read.auth.cognito.exception.CognitoPasswordInvalidException;
import io.fineo.read.auth.cognito.handle.DevicesHandler;
...
public class CognitoDevice {
     ...
     */
    protected final CognitoUser user;
